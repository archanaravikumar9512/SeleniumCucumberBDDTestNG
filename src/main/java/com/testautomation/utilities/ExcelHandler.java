...
public class ExcelHandler {
	public static Map<String, String> getTestDataInMap(String testDataFile, String sheetName, String testCaseId)
		...
		String query = null;
		query = String.format("SELECT * FROM %s WHERE FLAG='Yes' and TCID='%s'", sheetName, testCaseId);
	...
	public static void UpdateTestResultsToExcel(String testDataFilePath, String sheetName, String tcStatus,
		...
		try {
			...
			String query = String.format("UPDATE %s SET TestCaseStatus='%s' where TCID='%s'", sheetName, tcStatus,
					testCaseId);
